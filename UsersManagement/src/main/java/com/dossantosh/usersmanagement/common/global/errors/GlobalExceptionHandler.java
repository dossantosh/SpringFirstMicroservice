package com.dossantosh.usersmanagement.common.global.errors;
...
import com.dossantosh.usersmanagement.common.global.errors.custom.BusinessException;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles validation errors (MethodArgumentNotValidException) and returns HTTP 400 Bad Request.
     *
     * @param ex      the exception containing validation errors
     * @param request the current web request
     * @return ResponseEntity containing ApiError with validation details and 400 status
     */
